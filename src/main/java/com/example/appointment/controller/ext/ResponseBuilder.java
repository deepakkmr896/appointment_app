 ...
 * URL: www.redux.com
 */
package com.example.appointment.controller.ext;

import com.example.appointment.constants.ResourceConstants;
...
public class ResponseBuilder<T> {
	...
	public ResponseBuilder<T> accessToken(final String value) {
		this.headers.add(ResourceConstants.HEADER_ACCESS_TOKEN, value);
		return this;
	}

	public ResponseBuilder<T> location(final String value) {
		this.headers.add(ResourceConstants.HEADER_LOCATION, value);
		return this;
	}
